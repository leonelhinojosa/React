...
export const ItemDetailContainer = () =>{
    ...
    useEffect(()=> {
        ...
        const queryDoc = doc(querydb, 'ventas juegos de consola', detalleId)
        getDoc(queryDoc)
