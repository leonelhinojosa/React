...
/*/const Products = [
  ...
  {id:'04',category: 'juego4', juegos: 'otros', description:"Grand Theft Auto Five",   img:'https://dixgamer.com/wp-content/uploads/2016/11/gta-v.jpg', price:'200', stock: 7},
  {id:'05',category: 'juego5', juegos: 'otros', description:"Combo Battlefield 3-4 y hardline",   img:'https://dixgamer.com/wp-content/uploads/2022/05/combo-battlefield-3-4-y-hardline.jpg', price:'$300', stock: 4},
]/*/
export const Datos = ({greeting}) => {
  ...
  const {juegosId} = useParams();
    ...
    useEffect(()=>{
      ...
      const queryCollection = collection(querydb, 'ventas  juegos de consola')
